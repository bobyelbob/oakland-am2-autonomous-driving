...
output = cv2.VideoWriter('./lines_video.avi', 
                         cv2.VideoWriter_fourcc(*'XVID'), 
                         20, frame_size)
gray_output = cv2.VideoWriter('./gray_video.avi', 
                         cv2.VideoWriter_fourcc(*'XVID'), 
                         20, frame_size)
canny_output = cv2.VideoWriter('./canny_video.avi', 
                         cv2.VideoWriter_fourcc(*'XVID'), 
                         20, frame_size)
roi_output = cv2.VideoWriter('./roi_video.avi', 
                         cv2.VideoWriter_fourcc(*'XVID'), 
                         20, frame_size)
...
def process_frame(frame):
    ...
    result = weighted_img(line, frame)
...
while True:
    ...
    if ret:
        ...
        bus.write_byte_data(8, 0, steering_angle)
        # time.sleep(0.05)
        # time.sleep(0.05)
